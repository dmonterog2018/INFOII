...
class Jugador:
    def __init__(self):
        ...
        self.informe = [] #Inicializamos una lista vacia para el informe
    ...
    def crear_equipo(self):
        ...
        francotirador_instancia = francotirador(3, 3, 3, '', 0) #vida_maxima, vida_actual, dano, posicion, enfriamiento
        ...
        self.equipo.append(dicc_francotirador) #Guardamos los valores del francotirador en un diccionario dentro de la lista
        ...
        dicc_inteligencia = {'nombre': 'inteligencia', 'vida maxima': inteligencia_instancia.vida_maxima,
                             ...
                             'posicion': inteligencia_instancia.posicion, 'enfriamiento': inteligencia_instancia.enfriamiento}
        self.equipo.append(dicc_inteligencia) #Guardamos los valores de inteligencia en un diccionario dentro de la lista
    ...
    def posicionar_equipo(self):
        ...
        while True:
            ...
            if validar_celda(celda_medico, max_col, max_row) == True: #Validar que la celda esta dentro del tablero
                if comprobar_celda_disponible(celda_medico,self.equipo) == True: #Comprobamos que la celda no esta ocupada
        ...
        while True:
            ...
            if validar_celda(celda_artillero, max_col, max_row) == True: #Validar que la celda esta dentro del tablero
                if comprobar_celda_disponible(celda_artillero, self.equipo) == True: #Comprobamos que la celda no esta ocupada
        ...
        while True:
            ...
            if validar_celda(celda_francotirador, max_col, max_row) == True: #Validar que la celda esta dentro del tablero
                if comprobar_celda_disponible(celda_francotirador, self.equipo) == True: #Comprobamos que la celda no esta ocupada
        ...
        while True:
            ...
            if validar_celda(celda_inteligencia, max_col, max_row) == True: #Validar que la celda esta dentro del tablero
                if comprobar_celda_disponible(celda_inteligencia, self.equipo) == True: #Comprobamos que la celda no esta ocupada
    ...
    def calculo_celdas(self, celda_usuario, max_col, max_row):
        ...
        for row in range(row_usuario, min(row_usuario + 2, max_row + 1)): #Recorremos las filas
            for col in range(col_usuario, min(col_usuario + 2, ord(max_col.lower()) - ord('a') + 1)): #Recorremos las columnas
    ...
    def recibir_accion(self, tipo, celda_afectada):
        ...
        if tipo == 'f': #Si el tipo es Francotirador
            for miembro in self.oponente.equipo: #Recorremos la lista equipo enemigo
                if miembro['posicion'] == celda_afectada: #Comprobamos si en la casilla afectada se encuentra un miembro del equipo
                    miembro['vida actual'] = miembro['vida actual'] - self.equipo[2]['dano'] #Modificamos la vida del personaje con el daño del francotirador
                    print(f"El {miembro['nombre']} ha muerto en la celda: {celda_afectada}")
                    self.oponente.turno.append(f"Tu {miembro['nombre']} ha muerto :(") #Añadimos al informe que el personaje afectado a muerto
                else:
                    pass

        elif tipo =='a': #Si el tipo es Artillero
            afectados = self.calculo_celdas(celda_afectada, max_col, max_row) #Calculamos el area que va a ser afectada en el tablero
            for miembro in self.oponente.equipo: #Recorremos la lista equipo enemigo
                for i in afectados: #Recorremos una lista con las casilas afectadas
                    if miembro['posicion'] == i: #Comprobamos si hay algun personaje en las casillas
                        if miembro['vida actual'] > 0: #Comprobamos que el personaje este vivo
                            miembro['vida actual'] = miembro['vida actual'] - self.equipo[1]['dano']  #Modificamos la vida del personaje con el daño del artillero
    ...
    def realizar_accion(self):
        ...
        if self.equipo[0]['vida actual'] > 0 and self.equipo[0]['enfriamiento'] == 0: #Comprueba si el medico esta vivo y si se puede utilizar su habilidad
            for miembro in self.equipo: #Recorremos la lista equipo
                if miembro['vida actual'] < miembro['vida maxima'] and miembro['vida actual'] != 0: # Comprueba si se puede curar a alguno de los personajes
                    print('-----> 5. Habilidad (Medico) <-----')
                    break
        if self.equipo[1]['vida actual'] > 0 and self.equipo[1]['enfriamiento'] == 0: #Comprueba si el artillero esta vivo y si se puede utilizar su habilidad
            print('-----> 6. Habilidad (Artillero) <-----')
        if self.equipo[2]['vida actual'] > 0 and self.equipo[2]['enfriamiento'] == 0: #Comprueba si el francotirador esta vivo y si se puede utilizar su habilidad
            print('-----> 7. Habilidad (Francotirador) <-----')
        if self.equipo[3]['vida actual'] > 0 and self.equipo[3]['enfriamiento'] == 0: #Comprueba si inteligencia esta vivo y si se puede utilizar su habilidad
                ...
                if int(acc) <= 8: #Comprobar que la accion es menor/igual a 8 (opciones del menu)
                    if int(acc) == 1: #Accion 1 elegida (mover medico)
                        while True:
                            ...
                            if medico_instancia.mover(celda_nuevo, self.equipo) == True: #Comprobamos la celda a la que movemos
                                return True
                        ...
                        while True:
                            ...
                            if artillero_instancia.mover(celda_nuevo, self.equipo) == True: #Comprobamos la celda a la que movemos
                                return True

                    elif int(acc) == 3: #Accion 3 elegida
                        while True:
                            celda_nuevo = input('Introduce la celda a la que quiere mover el personaje: ').lower()
                            francotirador1 = self.equipo[2] #Guardamos en francotirador1 el tercer valor de la lista equipo
                            ...
                            if francotirador_instancia.mover(celda_nuevo, self.equipo) == True: #Comprobamos la celda a la que movemos
                                return True
                        ...
                        while True:
                            ...
                            if inteligencia_instancia.mover(celda_nuevo, self.equipo) == True: #Comprobamos la celda a la que movemos
                                return True
                        ...
                        while True:
                            ...
                            if medico_instancia.habilidad(celda_curar, self.equipo) == True:
                                ...
                                for elemento in self.equipo: #Recorremos la lista equipo
                                    if elemento['enfriamiento'] == 0: #Comrpobamos que el valor enfriamiento es igual a 0
                                        if elemento['posicion'] == celda_curar: #Comprobamos que la poscion sea igual a celda_curar
                                            print(f"El {elemento['nombre']} se ha curado en la celda: {celda_curar}")
                                            self.equipo[0]['enfriamiento'] = 2 #Cambiamos el valor de enfriamiento para que no se pueda utilizar en el siguiente turno
                                            return True
                                    else:
                        ...
                        while True:
                            ...
                            if artillero_instancia.habilidad(celda_marcada, self.equipo):
                                ...
                                self.equipo[1]['enfriamiento'] = 2 #Cambiamos el valor de enfriamiento para que no se pueda utilizar en el siguiente turno
                                return True
                        ...
                        while True:
                            ...
                            if francotirador_instancia.habilidad(celda_atacar, self.equipo):
                                ...
                                self.equipo[2]['enfriamiento'] = 2 #Cambiamos el valor de enfriamiento para que no se pueda utilizar en el siguiente turno
                                return True
                        ...
                        if inteligencia_instancia.habilidad(celda_marcada, self.equipo):
                            ...
                            self.equipo[3]['enfriamiento'] = 2 #Cambiamos el valor de enfriamiento para que no se pueda utilizar en el siguiente turno
                            return True
                else:
    ...
    def informe1(self):
        ...
        for elemento in self.equipo: #Recorremos la lista equipo
            if elemento['vida actual'] > 0: #Si el personaje esta vivo lo añadimos al informe con su posicion y la vida restante
    ...
    def turno1(self) -> bool:
        if self.turno_end == False: #Comprobamos si el turno ha terminado
            ...
            self.realizar_accion() #Llamamos a la funcion
            self.set_oponente(self.oponente) #Llamamos a la funcion

            if self.oponente.equipo[1]['vida actual'] <= 0 and self.oponente.equipo[2]['vida actual'] <= 0.: #Comprobamos si los miembros 1 y 2 del equipo rival han sido derrotados (personajes militares)
                   return True #Si se cumple la condicion el juego termina

    #Funcion para establecer el oponente
    def set_oponente(self,oponente):
        self.oponente = oponente #Asignamos el valor oponente
        return self.oponente #Devolvemos el valor oponente