...
#Funcion main principal que maneja el juego
def main():
    ...
    #Establecemos los oponentes
    j1.set_oponente(j2)
    j2.set_oponente(j1)

    #Establecemos el final como False
    final = False

    #Creamos un bucle que maneje el juego hasta que final = TRUE
    while not final:
